...
public class BoardCreator : MonoBehaviour
{
    ...
    // Dictionary maps from a Point struct to a Tile instance
    Dictionary<Point, Tile> tiles = new Dictionary<Point, Tile>();

    // Maximum ranges of extend that board may reach
    [SerializeField] int width = 10;
    [SerializeField] int depth = 10;
    [SerializeField] int height = 8;

    // Where individual modification takes place
    ...
    Rect RandomRect()
    {
        ...
        int h = UnityEngine.Random.Range(1, height - x + 1);
